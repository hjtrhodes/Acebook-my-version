      ...
      <form onSubmit={handleSubmit} className='text-center flex flex-col bg-white p-5 rounded-lg shadow-lg w-96 h-auto'>
        ...
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
          ...
          <p className='rendermessage'>
                            ...
                            <p className='rendermessage'>
                                These web services spin down with inactivity. If have clicked the Sign Up button and nothing has happened, you may have to wait a few minutes for the backend server to wake up then try again. Sorry about that, but why not take a well-earned break, go grab a cup of
                                tea and come back?
                            </p>
